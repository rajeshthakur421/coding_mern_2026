...
function maxSubarraySum(arr) {
    ...
    let maxCurrent = arr[0]; // Maximum sum of subarray ending at the current position
...
console.log("The largest sum of contiguous subarray is:", maxSubarraySum(arr)); // Output: 12
